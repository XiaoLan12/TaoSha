...
public class OrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == ITEM_HEADER) {
            view = LayoutInflater.from(context).inflate(R.layout.item_head_myorder, parent, false);
            return new OrderAdapter.MyViewHolderHeader(view);
        }else if(viewType == ITEM_CONTENT){
            view = LayoutInflater.from(context).inflate(R.layout.item_middle_myorder, parent, false);
            return new OrderAdapter.MyViewHolderContent(view);
        }else if(viewType == ITEM_FOOTER){
            view = LayoutInflater.from(context).inflate(R.layout.item_bottom_myorder, parent, false);
    ...
    public int getItemViewType(int position) {
        if(data.get(position) instanceof OrderHeadBean) {
            return ITEM_HEADER;
        }else if(data.get(position) instanceof Goods){
            return ITEM_CONTENT;
        }else if(data.get(position) instanceof OrderFootBean){
            return ITEM_FOOTER;
        }
        return ITEM_CONTENT;
    }
