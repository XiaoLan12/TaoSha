...
import com.yizhisha.taosha.widget.ClipView;
...
public class ClipHeaderActivity extends Activity implements OnTouchListener {
    ...
    private void initSrcPic() {
        ...
        bitmap = ImageUtils.decodeSampledBitmap(path, 720, 1280);
    ...
    private Bitmap getZoomedCropBitmap() {
        ...
        try {
            ...
            zoomedCropBitmap = ImageUtils.zoomBitmap(cropBitmap, side_length, side_length);
        } catch (Exception e) {
            e.printStackTrace();
        }
