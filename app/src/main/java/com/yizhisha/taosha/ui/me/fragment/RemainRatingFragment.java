...
public class RemainRatingFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private RemainRatingAdapter mAdapter;
    ...
    private void initAdapter(){
        ...
        mAdapter=new RemainRatingAdapter(dataList);
